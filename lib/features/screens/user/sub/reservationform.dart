...
class _ReservationFormScreenState extends State<ReservationFormScreen>
  ...
  void initState() {
    ...
    medicalReasonController.addListener(() {
      setState(() {}); // Rebuild UI when text changes to update button state
    });
  }

  @override
  void dispose() {
    medicalReasonController.dispose();
    super.dispose();
  }

  bool _isFormValid() {
    return selectedBloodType != null && medicalReasonController.text.isNotEmpty;
  }
  ...
  Future<void> _reserveBlood() async {
    ...
    if (medicalReasonController.text.isEmpty) {
      _showErrorSnackBar(
          'Please provide a medical reason for the reservation.');
      setState(() => isSubmitting = false);
      return;
    }
                              ...
                              FadeInRight(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText:
                                        'Please explain why you need this blood reservation...',
                                    hintStyle:
